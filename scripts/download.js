window.onload = function () {
    ...
    async function downloadPdfPages(pdfPageInfo) {
        ...
        document.getElementById("bookmarkInfo").value = bookmarkData;

        if (bookmarkData) {
            save(JSON.parse(bookmarkData), "bookmarks.json")
        }
        //No longer download .PDF as it is broken, but download and save bookmarks
        //
